...
public class SearchResultsListAdapter extends BaseAdapter {
	...
	public void renderThirdTextView(TextView textView,
		...
		if (offerDisplay.getOffer().pricePerKilogram <=9) {
			textView.setText("0" +offerDisplay.getOffer().pricePerKilogram + " €/"+swypeCatsGuiUtils.getOfferKg());
		}// end if: add extra space for alignment
		else
		// Set (Price) according to the offer
		textView.setText(offerDisplay.getOffer().pricePerKilogram + " €/"+swypeCatsGuiUtils.getOfferKg());
		// Add image
