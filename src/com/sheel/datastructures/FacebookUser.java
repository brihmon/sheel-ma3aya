...
public class FacebookUser {
	 ...
	 * constructors should NOT be used as the data in this data structure
	 * should be auto-generated by HTTP requests from facebook on login
	 * @param firstName 
	 * 		first name of facebook user
	 * @param middleName 
	 * 		middle name of facebook user
	 * @param lastName
	 * 		last name of facebook user
	 * @param gender
	 *  	<ul>
	 ...
	 * 		</ul> 
	 */
	public FacebookUser (String firstName , String middleName, String lastName , boolean gender){
	 ...
	 * 		</ul> 
	 * @param email
	 * 		Email of user used by facebook
	 * @param isverified
	 * 		Indicates whether user is trustworthy or not. 
